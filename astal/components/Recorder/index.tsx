  ...
  return (
    <PopupWindow
      ...
      anchor={options.widgets.bar
        .position()
        .as((p) =>
          p === "top" ? Astal.WindowAnchor.TOP : Astal.WindowAnchor.BOTTOM,
        )}
      exclusivity={Astal.Exclusivity.NORMAL}
    >
      <box spacing={options.theme.spacing()} className="recorder" vertical>
        <box spacing={options.theme.spacing()} className="options" vertical>
